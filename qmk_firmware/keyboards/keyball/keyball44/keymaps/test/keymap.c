...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,                                      KC_H   , KC_J   , KC_K   , KC_L   , LT(1, KC_MINS), KC_BSLS,
    KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                                      KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, TG(1)  ,
             KC_NO  , LT(3, KC_ESC), LT(1, KC_LALT), KC_LGUI, LT(4, KC_SPC),        MO(5)  , LT(2, KC_ENT), LT(3, KC_LBRC), KC_NO  , KC_NO
  ),
  ...
  // =========================================================
  [1] = LAYOUT_universal(
    _______, KC_1   , _______, _______, _______, _______,                                      _______, KC_F17 , KC_F19 , KC_F18 , KC_F13 , KC_F12 ,
    KC_F23 , KC_F22 , _______, _______, _______, KC_F15 ,                                      KC_BSPC, KC_MS_BTN1, KC_MS_BTN3, KC_MS_BTN2, KC_F16 , KC_F11 ,
    _______, _______, _______, _______, KC_SPC , KC_F14 ,                                      KC_VOLD, KC_VOLU, _______, KC_MUTE, _______, _______,
  ...
  // =========================================================
  [2] = LAYOUT_universal(
    _______, _______, _______, _______, _______, _______,                                      _______, KC_INT1, S(KC_7), S(KC_8), _______, _______,
    _______, _______, _______, _______, _______, _______,                                      KC_BSPC, KC_PLUS, KC_MINS, S(KC_BSLS),_______, _______,
    _______, _______, _______, _______, _______, _______,                                      _______, _______, KC_DOT , KC_COMM, _______, _______,
             _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______
  ),

  // =========================================================
  // Layer 3: RGB LED コントロール
  // =========================================================
  [3] = LAYOUT_universal(
    RGB_TOG, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,_______,                                      _______, _______, _______, _______, _______, _______,
    RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_M_SN,_______,                                      _______, _______, _______, _______, _______, _______,
    RGB_RMOD,RGB_HUD, RGB_SAD, RGB_VAD, RGB_M_K, _______,                                      _______, _______, _______, _______, _______, _______,
             _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______
  ),
